...
public class TimetableView extends LinearLayout{
    ...
    private void getAttrs(AttributeSet attrs) {
        ...
        headerHighlightColor = a.getColor(R.styleable.TimetableView_header_highlight_color, getResources().getColor(R.color.purple_200));
    ...
    private void add(final ArrayList<Schedule> schedules, int specIdx) {
        ...
        for (Schedule schedule : schedules) {
            ...
            tv.setText(schedule.getClassCode() + "\n" + schedule.getClassPlace());
    ...
    private int calCellWidth(){
        ...
        /*if((cell_w/(size.x-getPaddingLeft()-getPaddingRight()-sideCellWidth)*(columnCount-1))<(70)){
            cell_w=dp2Px(70);
        }*/
        return cell_w;
    }
